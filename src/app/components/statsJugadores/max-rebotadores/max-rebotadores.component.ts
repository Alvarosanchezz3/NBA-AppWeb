...
@Component({
  selector: 'app-max-rebotadores',
  standalone: true,
  imports: [CommonModule, HeaderComponent],
  templateUrl: './max-rebotadores.component.html',
  styleUrl: './max-rebotadores.component.css'
})
export class MaxRebotadoresComponent {
  ...
  ngOnInit(): void {
    this.apiService.getmaxRebounders().subscribe(
      (data) => {
