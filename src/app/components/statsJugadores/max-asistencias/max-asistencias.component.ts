...
@Component({
  selector: 'app-max-asistencias',
  standalone: true,
  imports: [CommonModule, HeaderComponent],
  templateUrl: './max-asistencias.component.html',
  styleUrl: './max-asistencias.component.css'
})
export class MaxAsistenciasComponent {
  ...
  ngOnInit(): void {
    this.apiService.getmaxAssistants().subscribe(
      (data) => {
